...
import { EzsignfoldersignerassociationCreateObjectV1Request } from '../models';
import { EzsignfoldersignerassociationCreateObjectV1Response } from '../models';
import { EzsignfoldersignerassociationDeleteObjectV1Response } from '../models';
import { EzsignfoldersignerassociationGetInPersonLoginUrlV1Response } from '../models';
import { EzsignfoldersignerassociationGetObjectV1Response } from '../models';
/**
...
export declare class ObjectEzsignfoldersignerassociationApi extends BaseAPI {
     ...
     */
    ezsignfoldersignerassociationCreateObjectV1(ezsignfoldersignerassociationCreateObjectV1Request: Array<EzsignfoldersignerassociationCreateObjectV1Request>, options?: any): Promise<import("axios").AxiosResponse<any>>;
    /**
     *
     * @summary Delete an existing Ezsignfoldersignerassociation
     * @param {number} pkiEzsignfoldersignerassociationID The unique ID of the Ezsignfoldersignerassociation
     ...
     * @memberof ObjectEzsignfoldersignerassociationApi
     */
    ezsignfoldersignerassociationDeleteObjectV1(pkiEzsignfoldersignerassociationID: number, options?: any): Promise<import("axios").AxiosResponse<any>>;
    /**
     *
     * @summary Retrieve an existing Ezsignfoldersignerassociation\'s children IDs
     * @param {number} pkiEzsignfoldersignerassociationID The unique ID of the Ezsignfoldersignerassociation
     ...
     * @memberof ObjectEzsignfoldersignerassociationApi
     */
    ezsignfoldersignerassociationGetInPersonLoginUrlV1(pkiEzsignfoldersignerassociationID: number, options?: any): Promise<import("axios").AxiosResponse<any>>;
    /**
     *
     * @summary Retrieve an existing Ezsignfoldersignerassociation
     * @param {number} pkiEzsignfoldersignerassociationID The unique ID of the Ezsignfoldersignerassociation
     ...
     * @memberof ObjectEzsignfoldersignerassociationApi
     */
    ezsignfoldersignerassociationGetObjectV1(pkiEzsignfoldersignerassociationID: number, options?: any): Promise<import("axios").AxiosResponse<any>>;
}
