...
export declare class ObjectEzsignsignatureApi extends BaseAPI {
     ...
     */
    ezsignsignatureCreateObjectV1(ezsignsignatureCreateObjectV1Request: Array<EzsignsignatureCreateObjectV1Request>, options?: any): Promise<import("axios").AxiosResponse<import("../model").CommonResponse>>;
    /**
     *
     * @summary Delete an existing Ezsignsignature
     * @param {number} pkiEzsignsignatureID The unique ID of the Ezsignsignature
     ...
     * @memberof ObjectEzsignsignatureApi
     */
    ezsignsignatureDeleteObjectV1(pkiEzsignsignatureID: number, options?: any): Promise<import("axios").AxiosResponse<import("../model").CommonResponse>>;
    /**
     *
     * @summary Retrieve an existing Ezsignsignature\'s children IDs
     * @param {number} pkiEzsignsignatureID The unique ID of the Ezsignsignature
     ...
     * @memberof ObjectEzsignsignatureApi
     */
    ezsignsignatureGetObjectV1(pkiEzsignsignatureID: number, options?: any): Promise<import("axios").AxiosResponse<import("../model").CommonResponse>>;
}
