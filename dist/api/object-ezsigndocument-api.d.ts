...
export declare const ObjectEzsigndocumentApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     */
    ezsigndocumentApplyEzsigntemplateV1: (pkiEzsigndocumentID: number, ezsigndocumentApplyEzsigntemplateV1Request: EzsigndocumentApplyEzsigntemplateV1Request, options?: any) => Promise<RequestArgs>;
    /**
...
export declare const ObjectEzsigndocumentApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    ezsigndocumentApplyEzsigntemplateV1(pkiEzsigndocumentID: number, ezsigndocumentApplyEzsigntemplateV1Request: EzsigndocumentApplyEzsigntemplateV1Request, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EzsigndocumentApplyEzsigntemplateV1Response>>;
    /**
     * The endpoint allows to create one or many elements at once.  The array can contain simple (Just the object) or compound (The object and its child) objects.  Creating compound elements allows to reduce the multiple requests to create all child objects.
     * @summary Create a new Ezsigndocument
     * @param {Array<EzsigndocumentCreateObjectV1Request>} ezsigndocumentCreateObjectV1Request
...
export declare class ObjectEzsigndocumentApi extends BaseAPI {
     ...
     */
    ezsigndocumentApplyEzsigntemplateV1(pkiEzsigndocumentID: number, ezsigndocumentApplyEzsigntemplateV1Request: EzsigndocumentApplyEzsigntemplateV1Request, options?: any): Promise<import("axios").AxiosResponse<import("../model").CommonResponse>>;
    /**
     * The endpoint allows to create one or many elements at once.  The array can contain simple (Just the object) or compound (The object and its child) objects.  Creating compound elements allows to reduce the multiple requests to create all child objects.
     * @summary Create a new Ezsigndocument
     * @param {Array<EzsigndocumentCreateObjectV1Request>} ezsigndocumentCreateObjectV1Request
     ...
     * @memberof ObjectEzsigndocumentApi
     */
    ezsigndocumentCreateObjectV1(ezsigndocumentCreateObjectV1Request: Array<EzsigndocumentCreateObjectV1Request>, options?: any): Promise<import("axios").AxiosResponse<import("../model").CommonResponse>>;
    /**
     *
     * @summary Delete an existing Ezsigndocument
     * @param {number} pkiEzsigndocumentID The unique ID of the Ezsigndocument
     ...
     * @memberof ObjectEzsigndocumentApi
     */
    ezsigndocumentDeleteObjectV1(pkiEzsigndocumentID: number, options?: any): Promise<import("axios").AxiosResponse<import("../model").CommonResponse>>;
    /**
     *
     * @summary Retrieve an existing Ezsigndocument\'s children IDs
     * @param {number} pkiEzsigndocumentID The unique ID of the Ezsigndocument
     ...
     * @memberof ObjectEzsigndocumentApi
     */
    ezsigndocumentGetDownloadUrlV1(pkiEzsigndocumentID: number, eDocumentType: 'Initial' | 'Signed' | 'Proof' | 'Proofdocument', options?: any): Promise<import("axios").AxiosResponse<import("../model").CommonResponse>>;
    /**
     *
     * @summary Retrieve an existing Ezsigndocument
     * @param {number} pkiEzsigndocumentID The unique ID of the Ezsigndocument
     ...
     * @memberof ObjectEzsigndocumentApi
     */
    ezsigndocumentGetObjectV1(pkiEzsigndocumentID: number, options?: any): Promise<import("axios").AxiosResponse<import("../model").CommonResponse>>;
}
