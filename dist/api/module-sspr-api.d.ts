...
export declare const ModuleSsprApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     */
    ssprResetPasswordRequestV1: (ssprResetPasswordRequestV1Request: SsprResetPasswordRequestV1Request, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    ssprResetPasswordV1: (ssprResetPasswordV1Request: SsprResetPasswordV1Request, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    ssprSendUsernamesV1: (ssprSendUsernamesV1Request: SsprSendUsernamesV1Request, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    ssprUnlockAccountRequestV1: (ssprUnlockAccountRequestV1Request: SsprUnlockAccountRequestV1Request, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    ssprUnlockAccountV1: (ssprUnlockAccountV1Request: SsprUnlockAccountV1Request, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    ssprValidateTokenV1: (ssprValidateTokenV1Request: SsprValidateTokenV1Request, options?: any) => Promise<RequestArgs>;
};
/**
...
export declare const ModuleSsprApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    ssprResetPasswordRequestV1(ssprResetPasswordRequestV1Request: SsprResetPasswordRequestV1Request, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>>;
    /**
     * This endpoint resets the user\'s password.  sEmailAddress must be set if eUserTypeSSPR = EzsignUser  sUserLoginname must be set if eUserTypeSSPR = Native
     * @summary Reset Password
     * @param {SsprResetPasswordV1Request} ssprResetPasswordV1Request
     ...
     * @throws {RequiredError}
     */
    ssprResetPasswordV1(ssprResetPasswordV1Request: SsprResetPasswordV1Request, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>>;
    /**
     * This endpoint returns an email with the username(s) matching the email address provided in case of forgotten username
     * @summary Send username(s)
     * @param {SsprSendUsernamesV1Request} ssprSendUsernamesV1Request
     ...
     * @throws {RequiredError}
     */
    ssprSendUsernamesV1(ssprSendUsernamesV1Request: SsprSendUsernamesV1Request, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>>;
    /**
     * This endpoint sends an email with a link to unlock the user account.  sEmailAddress must be set if eUserTypeSSPR = EzsignUser  sUserLoginname must be set if eUserTypeSSPR = Native
     * @summary Unlock Account Request
     * @param {SsprUnlockAccountRequestV1Request} ssprUnlockAccountRequestV1Request
     ...
     * @throws {RequiredError}
     */
    ssprUnlockAccountRequestV1(ssprUnlockAccountRequestV1Request: SsprUnlockAccountRequestV1Request, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>>;
    /**
     * This endpoint unlocks the user account.  sEmailAddress must be set if eUserTypeSSPR = EzsignUser  sUserLoginname must be set if eUserTypeSSPR = Native
     * @summary Unlock Account
     * @param {SsprUnlockAccountV1Request} ssprUnlockAccountV1Request
     ...
     * @throws {RequiredError}
     */
    ssprUnlockAccountV1(ssprUnlockAccountV1Request: SsprUnlockAccountV1Request, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>>;
    /**
     * This endpoint validates if a Token is valid and not expired.  sEmailAddress must be set if eUserTypeSSPR = EzsignUser  sUserLoginname must be set if eUserTypeSSPR = Native
     * @summary Validate Token
     * @param {SsprValidateTokenV1Request} ssprValidateTokenV1Request
     ...
     * @throws {RequiredError}
     */
    ssprValidateTokenV1(ssprValidateTokenV1Request: SsprValidateTokenV1Request, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>>;
};
/**
