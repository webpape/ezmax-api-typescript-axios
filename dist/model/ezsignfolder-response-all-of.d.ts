 ...
 */
export declare class EzsignfolderResponseAllOfSchema extends ModelSchema {
    schema: {
        fkiEzsignfoldertypeID: Joi.NumberSchema;
        fkiEzsigntsarequirementID: Joi.NumberSchema;
        sEzsignfolderDescription: Joi.StringSchema;
        tEzsignfolderNote: Joi.StringSchema;
        eEzsignfolderSendreminderfrequency: Joi.AnySchema;
        pkiEzsignfolderID: Joi.NumberSchema;
        dtEzsignfolderSentdate: Joi.StringSchema;
        eEzsignfolderStep: Joi.AnySchema;
        dtEzsignfolderClose: Joi.StringSchema;
