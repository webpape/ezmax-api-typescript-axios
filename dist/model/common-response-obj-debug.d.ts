 ...
 */
export declare class CommonResponseObjDebugSchema extends ModelSchema {
    schema: {
        sMemoryUsage: Joi.StringSchema;
        sRunTime: Joi.StringSchema;
        iSQLSelects: Joi.NumberSchema;
        iSQLQueries: Joi.NumberSchema;
        a_objSQLQuery: Joi.AnySchema;
    };
}
