 ...
 */
export declare class ContactinformationsRequestSchema extends ModelSchema {
    schema: {
        iAddressDefault: Joi.NumberSchema;
        iPhoneDefault: Joi.NumberSchema;
        iEmailDefault: Joi.NumberSchema;
        iWebsiteDefault: Joi.NumberSchema;
    };
}
