 ...
 */
export declare class PhoneRequestSchema extends ModelSchema {
    schema: {
        fkiPhonetypeID: Joi.NumberSchema;
        ePhoneType: Joi.AnySchema;
        sPhoneRegion: Joi.StringSchema;
        sPhoneExchange: Joi.StringSchema;
        sPhoneNumber: Joi.StringSchema;
        sPhoneInternational: Joi.StringSchema;
