 ...
 */
export declare class AttemptResponseSchema extends ModelSchema {
    schema: {
        dtAttemptStart: Joi.StringSchema;
        sAttemptResult: Joi.StringSchema;
        iAttemptDuration: Joi.NumberSchema;
    };
}
