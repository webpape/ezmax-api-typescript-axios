 ...
 */
export declare class ActivesessionGetCurrentV1ResponseMPayloadSchema extends ModelSchema {
    schema: {
        sCustomerCode: Joi.StringSchema;
        eActivesessionSessiontype: Joi.StringSchema;
        fkiLanguageID: Joi.NumberSchema;
        sCompanyNameX: Joi.StringSchema;
        sDepartmentNameX: Joi.StringSchema;
        a_RegisteredModules: Joi.AnySchema;
        a_Permissions: Joi.AnySchema;
        fkiUserID: Joi.NumberSchema;
        fkiApikeyID: Joi.NumberSchema;
    };
}
