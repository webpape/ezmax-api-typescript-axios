 ...
 */
export declare class FranchisereferalincomeCreateObjectV1RequestSchema extends ModelSchema {
    schema: {
        objFranchisereferalincome: Joi.AnySchema;
        objFranchisereferalincomeCompound: Joi.AnySchema;
    };
}
