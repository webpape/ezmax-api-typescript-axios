 ...
 */
export declare class SsprResetPasswordV1RequestSchema extends ModelSchema {
    schema: {
        pksCustomerCode: Joi.StringSchema;
        fkiLanguageID: Joi.NumberSchema;
        eUserTypeSSPR: Joi.AnySchema;
        sEmailAddress: Joi.StringSchema;
        sUserLoginname: Joi.StringSchema;
        binUserSSPRtoken: Joi.StringSchema;
        sPassword: Joi.StringSchema;
    };
}
