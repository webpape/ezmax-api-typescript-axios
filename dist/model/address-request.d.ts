 ...
 */
export declare class AddressRequestSchema extends ModelSchema {
    schema: {
        fkiAddresstypeID: Joi.NumberSchema;
        sAddressCivic: Joi.StringSchema;
        sAddressStreet: Joi.StringSchema;
        sAddressSuite: Joi.StringSchema;
        sAddressCity: Joi.StringSchema;
        fkiProvinceID: Joi.NumberSchema;
        fkiCountryID: Joi.NumberSchema;
        sAddressZip: Joi.StringSchema;
    };
}
