...
/**
    ...
    * @enum {string}
    */
export declare enum EzsignsignerRequestEEzsignsignerLogintypeEnum {
    Password = "Password",
 ...
 */
export declare class EzsignsignerRequestSchema extends ModelSchema {
    schema: {
        fkiTaxassignmentID: Joi.NumberSchema;
        fkiSecretquestionID: Joi.NumberSchema;
        eEzsignsignerLogintype: Joi.StringSchema;
        sEzsignsignerSecretanswer: Joi.StringSchema;
    };
}
