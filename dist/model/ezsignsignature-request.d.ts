...
/**
    ...
    * @enum {string}
    */
export declare enum EzsignsignatureRequestEEzsignsignatureTypeEnum {
 ...
 */
export declare class EzsignsignatureRequestSchema extends ModelSchema {
    schema: {
        fkiEzsignfoldersignerassociationID: Joi.NumberSchema;
        iEzsignpagePagenumber: Joi.NumberSchema;
        iEzsignsignatureX: Joi.NumberSchema;
        iEzsignsignatureY: Joi.NumberSchema;
        iEzsignsignatureStep: Joi.NumberSchema;
        eEzsignsignatureType: Joi.StringSchema;
        fkiEzsigndocumentID: Joi.NumberSchema;
    };
}
