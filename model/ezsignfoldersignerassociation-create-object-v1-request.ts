 ...
 */
export class EzsignfoldersignerassociationCreateObjectV1RequestSchema extends ModelSchema {
    schema = {
        objEzsignfoldersignerassociation: Joi.any(),
        objEzsignfoldersignerassociationCompound: Joi.any(),
    }
}
