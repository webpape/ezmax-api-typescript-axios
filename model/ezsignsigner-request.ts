 ...
 */
export class EzsignsignerRequestSchema extends ModelSchema {
    schema = {
        fkiTaxassignmentID: Joi.number().required(),
        fkiSecretquestionID: Joi.number(),
        eEzsignsignerLogintype: Joi.string().required(),
        sEzsignsignerSecretanswer: Joi.string(),
    }
}
