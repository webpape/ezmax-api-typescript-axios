 ...
 */
export class FranchisereferalincomeCreateObjectV1RequestSchema extends ModelSchema {
    schema = {
        objFranchisereferalincome: Joi.any(),
        objFranchisereferalincomeCompound: Joi.any(),
    }
}
