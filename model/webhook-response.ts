 ...
 */
export class WebhookResponseSchema extends ModelSchema {
    schema = {
        pkiWebhookID: Joi.number().required(),
        eWebhookModule: Joi.string().required(),
        eWebhookEzsignevent: Joi.string(),
        pksCustomerCode: Joi.string().required().max(6).min(2),
        sWebhookUrl: Joi.string().required(),
        sWebhookEmailfailed: Joi.string().required(),
        eWebhookManagementevent: Joi.string(),
    }
}
