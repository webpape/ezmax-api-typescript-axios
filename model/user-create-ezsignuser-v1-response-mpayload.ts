 ...
 */
export class UserCreateEzsignuserV1ResponseMPayloadSchema extends ModelSchema {
    schema = {
        a_sEmailAddressSuccess: Joi.any().required(),
        a_sEmailAddressFailure: Joi.any().required(),
    }
}
