 ...
 */
export class EzsignsignatureRequestSchema extends ModelSchema {
    schema = {
        fkiEzsignfoldersignerassociationID: Joi.number().required(),
        iEzsignpagePagenumber: Joi.number().required(),
        iEzsignsignatureX: Joi.number().required(),
        iEzsignsignatureY: Joi.number().required(),
        iEzsignsignatureStep: Joi.number().required(),
        eEzsignsignatureType: Joi.string().required(),
        fkiEzsigndocumentID: Joi.number().required(),
    }
}
