 ...
 */
export class EzsigndocumentRequestSchema extends ModelSchema {
    schema = {
        eEzsigndocumentSource: Joi.string().required(),
        eEzsigndocumentFormat: Joi.string().required(),
        sEzsigndocumentBase64: Joi.string(),
