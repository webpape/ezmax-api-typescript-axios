 ...
 */
export class PhoneRequestSchema extends ModelSchema {
    schema = {
        fkiPhonetypeID: Joi.number().required(),
        ePhoneType: Joi.any().required(),
        sPhoneRegion: Joi.string(),
        sPhoneExchange: Joi.string(),
        sPhoneNumber: Joi.string(),
        sPhoneInternational: Joi.string(),
