 ...
 */
export class AddressRequestSchema extends ModelSchema {
    schema = {
        fkiAddresstypeID: Joi.number().required(),
        sAddressCivic: Joi.string().required(),
        sAddressStreet: Joi.string().required(),
        sAddressSuite: Joi.string().required(),
        sAddressCity: Joi.string().required(),
        fkiProvinceID: Joi.number().required(),
        fkiCountryID: Joi.number().required(),
        sAddressZip: Joi.string().required(),
    }
}
