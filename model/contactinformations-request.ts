 ...
 */
export class ContactinformationsRequestSchema extends ModelSchema {
    schema = {
        iAddressDefault: Joi.number().required(),
        iPhoneDefault: Joi.number().required(),
        iEmailDefault: Joi.number().required(),
        iWebsiteDefault: Joi.number().required(),
    }
}
